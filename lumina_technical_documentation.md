...
2. **[Deployment Infrastructure](docs/deployment.md)** — Docker setup, Nginx configuration, Uvicorn scaling, and the CI/CD Deployment Pipeline.
3. **[Security & Threat Models](docs/security.md)** — Prompt Injection defense, XSS mitigation, and the Threat Model Flowchart.
4. **[LLM Routing Engine](docs/routing.md)** — Pre-flight search intent classification, 5-Tier Brain State persona mapping, and the MLOps/AIOps Lifecycle.
...
9. **[Observability](docs/observability.md)** — Telemetry, logging formats, metrics tracing, system monitoring, and the SRE Alerting Feedback Loop.
